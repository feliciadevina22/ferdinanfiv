...
<head>
  <meta charset="utf-8">
  <title>FERDINANFIV - {{$store->title}} </title>
  ...
  <link href="../css/cartnumber.css" rel="stylesheet">
...
<section class="section">
  <div class="container">
    ...
    <div class="row shuffle-wrapper">
      ...
      <div class="col-lg-4 col-6 mb-4 shuffle-item" data-groups="[&quot;branding&quot;]">
        <div class=" rounded hover-wrapper">
          <img src="../storage/store_image/{{$store->pic}}" alt="portfolio-image" class="img-fluid rounded w-100 d-block" >
        </div>
      </div>
    ...
    <div>
      ...
      <h5>Stock : {{$store->stock}}</h5>
    </div>
    <div class="input-group">
      <input type="button" value="-" class="button-minus" data-field="quantity" style="background-color: #3b1c85; color: white">
      <input type="number" step="1" max="" value="1" name="quantity" class="quantity-field" style="font-family: arial">
      <input type="button" value="+" class="button-plus" data-field="quantity" style="background-color: #3b1c85;color: white">
      <button type="button" class="btn purple-gradient text-white" style="background: linear-gradient(40deg, #3B1C85, #41228E); font-family: arial; width: 150px; padding: 0;font-size: 16px">Add to Cart</button>
    </div>
