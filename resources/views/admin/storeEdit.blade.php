...
<head>
  ...
  <title>FERDINANFIV Admin- Store</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Edit Store Item</h1>
          ...
          <!-- <div class="row"> -->
            ...
            {!! Form::open(['action' => ['adminStoreController@update', $store->id], 'method' => 'POST',
            'enctype'=>'multipart/form-data']) !!}
            <div class="form-group">
              {{Form::label('title', 'Title')}}
              {{Form::text('title', $store->title, 
              ['class' => 'form-control', 
              'placeholder' => 'Title' ])}}
            </div> 
            ...
            <div class="form-group">
              ...
              <br>
              {{Form::textarea('description', $store->desc, 
              ['class' => 'form-control', 
